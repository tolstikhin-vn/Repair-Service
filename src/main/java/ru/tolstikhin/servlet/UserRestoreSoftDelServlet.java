...
@WebServlet(name = "UserRestoreSoftDelServlet", value = "/user-restore-soft-del")
public class UserRestoreSoftDelServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(UserRestoreSoftDelServlet.class);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if (userDAO.userRestoreSoftDel(userId)) {
