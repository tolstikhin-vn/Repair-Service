...
@WebServlet(name = "UserHardDelServlet", value = "/user-hard-del")
public class UserHardDelServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(UserHardDelServlet.class);
