...
@WebServlet(name = "UserSoftDelServlet", value = "/user-soft-del")
public class UserSoftDelServlet extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(UserSoftDelServlet.class);
